angular.module('operationsDirective').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('common/templates/sn-about-dialog.html',
    "<md-dialog ng-controller=\"snAboutDlgCtrl\"><md-content>The SatNet Network</md-content><div class=\"md-actions\"><md-button ng-click=\"closeDialog()\">Close</md-button></div></md-dialog>"
  );
